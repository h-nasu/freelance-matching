<template>
  <v-flex xs12 sm8 md4>
    <v-card class="elevation-12">
      ...
      <v-card-actions>
        <v-spacer></v-spacer>
        <v-btn @click="onSubmit(email)" color="primary">Request Reset Password</v-btn>
      </v-card-actions>
    </v-card>

    <v-dialog v-model="registerComplete" persistent max-width="290">
      <v-card>
        <v-card-title class="headline">Change Password Request Complete</v-card-title>
        <v-card-text>Please check your email and change your password.</v-card-text>
        <v-card-actions>
          <v-spacer></v-spacer>
